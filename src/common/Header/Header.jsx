...
//               src={logo}
//               alt="Additional"
//               className="header-img-logo header-img w-24 h-auto sm:w-32 mt-4 "
//             />
//           </Link>
//         </div>
//       </header>
    ...
    <div className="header-container">
      <header>
        <Link to="/" className="header-img">
          <img src={kmg} alt="Logo" className="header-img" />
        </Link>
        ...
        <Link to="/" className="header-img-logo">
          <img src={logo} alt="Additional" className="header-img-logo" />
        </Link>
      </header>
    </div>
  );
